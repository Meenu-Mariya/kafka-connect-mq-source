...
| `mq.ssl.keystore.content`                       | Base64-encoded contents of the JKS keystore to use for SSL (TLS) connections. If provided, this takes precedence over `mq.ssl.keystore.location`. Supports two approaches: (1) Inline base64 string directly in config, or (2) Reference to base64 content via ConfigProvider (e.g., `${directory:/path:file}`) | string  |                | Base64-encoded JKS keystore content                                                                                                                                                                 |
...
| `mq.ssl.truststore.content`                     | Base64-encoded contents of the JKS truststore to use for SSL (TLS) connections. If provided, this takes precedence over `mq.ssl.truststore.location`. Supports two approaches: (1) Inline base64 string directly in config, or (2) Reference to base64 content via ConfigProvider (e.g., `${directory:/path:file}`) | string  |                | Base64-encoded JKS truststore content                                                                                                                                                               |
